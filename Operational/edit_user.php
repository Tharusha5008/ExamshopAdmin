<?php
   ...
   if (isset($_POST['update'])) {
      ...
      $name = $_POST['name'];
   	...
   	$updatep = $conn->prepare("UPDATE users SET name = ?, username = ?, password = ? WHERE id = ?");
...
<div class="main">
	...
	<section class="edit-post">
		...
		<?php
           ...
           $select_ops = $conn->prepare("SELECT * FROM users WHERE id = ?");
		...
		<div class="form-container">
			<form action="" method="post" enctype="multipart/form-data">
				...
				<div class="input-field">
					<label>email</label>
					<input type="text" name="email" value="<?=$fetch_ops['username']; ?>">
				</div>
				<div class="input-field">
